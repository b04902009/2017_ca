...
silent only
cd ~/2017_ca/project1/code_pipeline
...
badd +0 EXMEM.v
badd +0 IDEX.v
badd +2 ForwardUnit.v
badd +30 Control.v
badd +0 MUX_Control.v
badd +0 ALU.v
badd +0 DataMemory.v
badd +0 testbench.v
badd +25 /tmp/CA2015project1/Control.v
argglobal
silent! argdel *
argadd Registers.v
set stal=2
...
silent! normal! zE
let s:l = 167 - ((0 * winheight(0) + 21) / 43)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 215 - ((22 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
215
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 52 - ((12 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 291 - ((41 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
291
